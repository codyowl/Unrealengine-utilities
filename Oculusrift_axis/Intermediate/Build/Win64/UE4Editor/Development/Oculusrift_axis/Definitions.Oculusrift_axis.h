...
#define ORIGINAL_FILE_NAME "UE4Editor-Oculusrift_axis.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME Oculusrift_axis
#define DEPRECATED_FORGAME DEPRECATED
#define OCULUSRIFT_AXIS_API DLLEXPORT
